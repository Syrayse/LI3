...
2. Determinar a lista e o nº total de produtos cujo código se inicia por uma dada letra (maiúscula). __NOT IMPLEMENTED__.
...
11. Criar uma lista dos N produtos mais vendidados em todo o ano, indicando o número total de clientes e o número de unidades vendaidas, filial a filial. __NOT IMPLEMENTED__.
...
Devido ao aumento com esta segunda fase, apresenta-se a seguinte proposta de repartição de trabalho pelos membros do grupo:
