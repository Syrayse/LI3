...
typedef struct sgv
{
    ...
    double start,   /**< Indica o tempo em que começou a ultima query. */
        end,        /**< Indica o tempo em que acabou a ultima query. */
        elapsed;    /**< Indica o tempo que demorou a ultima query. */
