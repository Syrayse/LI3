...
int get_product_global_stats(Accounting a, char *product_code, int month, int *trans_vec, double *spent_vec);       /* Q3 */
int get_product_per_filial_stats(Accounting a, char *product_code, int month, int **trans_vec, double **spent_vec); /* Q3 */
